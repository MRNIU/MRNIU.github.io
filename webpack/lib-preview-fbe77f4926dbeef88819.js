...
ie(M.display,T.display,E[1-_].display)||ie(M.display,T.display,C[1-x].display)||!(0<T.display-M.display)||M.display===E[0].display&&T.display===E[1].display||M.display===C[0].display&&T.display===C[1].display||w[S][M.display]||(w[S][T.display]=!0,b[S].push({start:M,end:T}))}var R,N,O,I,P,A,j,L,B,D,U,F,q,W,H,z,V,Y,Z=[],X=r.width,J=r.height,G=(R=t,N=n,O=(0,oe.getMinBoundingRect)({width:R.width,height:R.height,top:R.top,left:R.left,rotate:R.ro}),I=(0,re.default)(O,4),P=I[0],A=I[1],j=I[2],L=I[3],B=N.width,
D=N.left,U=N.top,F=A+j,q=D+B,W=P+L,H=U+N.height,Y=V=z=!1,(A<=D&&q<=F&&P<=U&&H<=W||D<=A&&A<=q&&U<=P&&W<=H)&&(Y=!0),(D<=A&&A<=q||A<=D&&D<=F)&&(z=!0),(P<=U&&U<=W||U<=P&&P<=H)&&(V=!0),{ifHorizontal:z,ifVertical:V,ifAllWraped:Y}),K=G.ifHorizontal,Q=G.ifVertical,$=G.ifAllWraped,ee=function(e){switch(e){case"horizontal":case"vertical":return delete b[e]
...
n="horizontal"===a?{left:"".concat(e.start.display/X*100,"%"),width:"".concat((e.end.display-e.start.display)/X*100,"%"),top:"".concat((d/2+u)/J*100,"%")}:{top:"".concat(e.start.display/J*100,"%"),height:"".concat((e.end.display-e.start.display)/J*100,"%"),left:"".concat((s/2+l)/X*100,"%")},Object.assign(n,{zIndex:Math.pow(2,31)})
...
var r=n("284h"),a=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var N=a(n("J4zp")),o=a(n("lwsE")),i=a(n("W8MJ")),u=a(n("a1gu")),l=a(n("Nsbk")),c=a(n("7W2i")),s=a(n("PJYZ")),d=a(n("lSNA")),f=a(n("17x9")),O=r(n("q1tI")),I=a(n("M8nv")),P=a(n("foKU")),A=a(n("tBsX")),j=n("oose"),L=a(n("dYO+")),B=a(n("DdUa")),D=a(n("kJQk")),U=a(n("9ZUU")),F=a(n("TSYQ"))
n("fSKh")
...
return O.default.createElement(P.default,{x:h,y:m,scale:t,id:"simulator-container",className:R,onMouseDown:this.handleMouseDown,onScaleChange:this.handleScaleChange,onOffsetChange:this.handleOffsetChange},function(e,t,n){return O.default.createElement("div",{key:"1",className:(0,F.default)("screen-viewport",{"is-fullscreen":p,"is-geely":"geely_center_control"===a.model}),style:x},O.default.createElement("div",{className:"zoom-area",style:k},O.default.createElement(B.default,null),
!g&&O.default.createElement(L.default,{project:a,shellType:y,isLandscape:v}),c&&O.default.createElement(U.default,null)),O.default.createElement("div",{className:"no-zoom-area-wrapper",style:M},O.default.createElement("div",{className:"no-zoom-area",style:T},O.default.createElement("div",{id:"ui-layers",className:"ui-layers ".concat(s?"is-active":"")},f&&O.default.createElement(D.default,null),s&&!f&&O.default.createElement(A.default,null)),O.default.createElement("div",{id:"ui-comment-marker-panel"},
O.default.createElement(j.CommentMarkerPanelContainer,{getContentElement:r.getContentElementRef})))))},O.default.createElement(I.default,{onKeyDown:this.handleKeyDown,onKeyUp:this.handleKeyUp}))}}]),t}(O.PureComponent);(t.default=p).propTypes={scale:f.default.number,canvasOffset:f.default.object,screen:f.default.object,project:f.default.object,shellType:f.default.string,isStickyShow:f.default.bool,isScrollable:f.default.bool,isSpaceDown:f.default.bool,isLayerActive:f.default.bool,
...
var w="proc first argument (Saga function result) must be an iterator",J={toString:function(){return"@@redux-saga/CHANNEL_END"}},G={toString:function(){return"@@redux-saga/TASK_CANCEL"}},o={wildcard:function(){return H.r},default:function(t){return"symbol"===(void 0===t?"undefined":a(t))?function(e){return e.type===t}:function(e){return e.type===String(t)}},array:function(e){return function(t){return e.some(function(e){return K(e)(t)})}},predicate:function(t){return function(e){return t(e)}}}
...
!t&&e.stack&&(t=-1!==e.stack.split("\n")[0].indexOf(e.message)?e.stack:"Error: "+e.message+"\n"+e.stack),c("error","uncaught at "+N,t||e.message||e)},A=Object(z.f)(M),j=Object.create(e)
y.cancel=H.u
var u,s,d,f,p,h,m,L=(u=a,s=N,f=t,(d=r)._deferredEnd=null,(h={})[H.e]=!0,h.id=u,h.name=s,(m={})[p="done"]=m[p]||{},m[p].get=function(){if(d._deferredEnd)return d._deferredEnd.promise
var e=Object(H.l)()
return d._deferredEnd=e,d._isRunning||(d._error?e.reject(d._error):e.resolve(d._result)),e.promise},h.cont=f,h.joiners=[],h.cancel=g,h.isRunning=function(){return d._isRunning},h.isCancelled=function(){return d._isCancelled},h.isAborted=function(){return d._isAborted},h.result=function(){return d._result},h.error=function(){return d._error},h.setContext=function(e){Object(H.h)(e,H.q.object,Object(H.k)("task",e)),H.v.assign(j,e)},function(e,t){for(var n in t){var r=t[n]
r.configurable=r.enumerable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,n,r)}}(h,m),h),B={name:N,cancel:function(){B.isRunning&&!B.isCancelled&&(B.isCancelled=!0,y(G))},isRunning:!0},v=function(e,r,a){var o=[],i=void 0,c=!1
function u(e){n(),a(e,!0)}function t(n){o.push(n),n.cont=function(e,t){c||(Object(H.w)(o,n),n.cont=H.u,t?u(e):(n===r&&(i=e),o.length||(c=!0,a(i))))}}function n(){c||(c=!0,o.forEach(function(e){e.cont=H.u,e.cancel()}),o=[])}return t(r),{addTask:t,cancelAll:n,abort:u,getTasks:function(){return o},taskNames:function(){return o.map(function(e){return e.name})}}}(0,B,b)
function g(){r._isRunning&&!r._isCancelled&&(r._isCancelled=!0,v.cancelAll(),b(G))}return t&&(t.cancel=g),r._isRunning=!0,y(),L
function y(e,t){if(!B.isRunning)throw new Error("Trying to resume an already finished generator")
try{var n=void 0;(n=t?r.throw(e):e===G?(B.isCancelled=!0,y.cancel(),H.q.func(r.return)?r.return(G):{done:!0,value:G}):e===J?H.q.func(r.return)?r.return():{done:!0}:r.next(e)).done?(B.isMainRunning=!1,B.cont&&B.cont(n.value)):D(n.value,a,"",y)}catch(e){B.isCancelled&&P(e),B.isMainRunning=!1,B.cont(e,!0)}}function b(t,n){r._isRunning=!1,A.close(),n?(t instanceof Error&&Object.defineProperty(t,"sagaStack",{value:"at "+N+" \n "+(t.sagaStack||t.stack),configurable:!0}),L.cont||(t instanceof Error&&i?i(t):P(t)),
r._error=t,r._isAborted=!0,r._deferredEnd&&r._deferredEnd.reject(t)):(r._result=t,r._deferredEnd&&r._deferredEnd.resolve(t)),L.cont&&L.cont(t,n),L.joiners.forEach(function(e){return e.cb(t,n)}),L.joiners=null}function D(e,t){var n=2<arguments.length&&void 0!==arguments[2]?arguments[2]:"",r=arguments[3],a=Object(H.y)()
...
n=n||A
var o=function(e){return e instanceof Error?t(e,!0):Object(z.e)(e)&&!a?t(J):t(e)}
...
else if(!Object(z.e)(e)&&e!==J&&e!==G){var n
g.cancel(),y=!0
var r=((n={})[a]=e,n)
g(H.q.array(m)?[].slice.call(X({},r,{length:b.length})):r)}}
e.cancel=H.u,w[a]=e}),g.cancel=function(){y||(y=!0,b.forEach(function(e){return w[e].cancel()}))},void b.forEach(function(e){y||D(m[e],v,e,w[e])})):(k=Y.d.call(e))?function(e,t,n){var r=e.context,a=e.fn,o=e.args,i=void 0
...
r.apply(t,a.concat(o)),o.cancel&&(n.cancel=function(){return o.cancel()})}catch(e){return n(e,!0)}}(k,i):(k=Y.d.fork(e))?q(k,a,i):(k=Y.d.join(e))?function(e,t){if(e.isRunning()){var n={task:L,cb:t}
t.cancel=function(){return Object(H.w)(e.joiners,n)},e.joiners.push(n)}else e.isAborted()?t(e.error(),!0):t(e.result())}(k,i):(k=Y.d.cancel(e))?function(e,t){e===H.d&&(e=L)
e.isRunning()&&e.cancel()
t()}(k,i):(k=Y.d.select(e))?function(e,t){var n=e.selector,r=e.args
try{var a=n.apply(void 0,[R()].concat(r))
t(a)}catch(e){t(e,!0)}}(k,i):(k=Y.d.actionChannel(e))?(d=i,f=(s=k).pattern,p=s.buffer,(h=K(f)).pattern=f,void d(Object(z.d)(M,p||Z.a.fixed(),h))):(k=Y.d.flush(e))?(l=i,void k.flush(l)):(k=Y.d.cancelled(e))?void i(!!B.isCancelled):(k=Y.d.getContext(e))?void i(j[k]):(k=Y.d.setContext(e))?(c=k,u=i,H.v.assign(j,c),void u()):i(e)}function U(e,t){var n=e[H.a]
H.q.func(n)?t.cancel=n:H.q.func(e.abort)&&(t.cancel=function(){return e.abort()}),e.then(t,function(e){return t(e,!0)})}function F(e,t,n,r){S(e,M,T,R,j,l,t,n,r)}function q(e,t,n){var r=e.context,a=e.fn,o=e.args,i=e.detached,c=function(e){var t=e.context,n=e.fn,r=e.args
...
try{Object(V.c)()
var u=S(c,M,T,R,j,l,t,a.name,i?null:H.u)
...
o.forEach(function(n){var e=function(e,t){c||(t||Object(z.e)(e)||e===J||e===G?(a.cancel(),a(e,t)):(u[n]=e,++i===o.length&&(c=!0,a(H.q.array(r)?H.f.from(X({},u,{length:o.length})):u))))}
e.cancel=H.u,l[n]=e}),a.cancel=function(){c||(c=!0,o.forEach(function(e){return l[e].cancel()}))},o.forEach(function(e){return D(r[e],t,e,l[e])})}}var v="runSaga(storeInterface, saga, ...args): saga argument must be a Generator function!"
...
var c=n("v4Lw")
Object.keys(c).forEach(function(e){"default"!==e&&"__esModule"!==e&&Object.defineProperty(t,e,{enumerable:!0,get:function(){return c[e]}})})},DJvY:function(e,t,n){"use strict"
var r=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
...
return t}},function(e,L,t){"use strict";(function(e){var c=t(35),o=t(36),i=t(37)
...
if(isNaN(c))return i
e[n+i]=c}return i}function y(e,t,n,r){return j(function(e){for(var t=[],n=0;n<e.length;++n)t.push(255&e.charCodeAt(n))
...
case"base64":return u=this,l=t,s=n,j(A(e),u,l,s)
case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return i=t,c=n,j(function(e,t){for(var n,r,a,o=[],i=0;i<e.length&&!((t-=2)<0);++i)r=(n=e.charCodeAt(i))>>8,a=n%256,o.push(a),o.push(r)
...
n.d(t,"m",function(){return x}),n.d(t,"j",function(){return k}),n.d(t,"y",function(){return T}),n.d(t,"t",function(){return O}),n.d(t,"s",function(){return I}),n.d(t,"n",function(){return P}),n.d(t,"z",function(){return A}),n.d(t,"p",function(){return j}),n.d(t,"k",function(){return L}),n.d(t,"A",function(){return B}),n.d(t,"i",function(){return D})
var r=Object.assign||function(e){for(var t=1;t<arguments.length;t++){var n=arguments[t]
...
,t){return(e?e+".":"")+"setContext(props): argument "+t+" is not a plain object"},B=function(t){return function(e){return t(Object.defineProperty(e,s,{value:!0}))}},D=function o(i){return function(){for(var e=arguments.length,n=Array(e),t=0;t<e;t++)n[t]=arguments[t]
...
return Number(n)?t:r}},G916:function(e,t,n){e.exports={nav:"xnJdrPjsJoJrp1VupFyUM","nav-item":"_3UspVqDrjxaWG9BSMdj9jf"}},GDhZ:function(e,t,n){var a=n("wF/u"),o=n("mwIZ"),i=n("hgQt"),c=n("9ggG"),u=n("CMye"),l=n("IOzZ"),s=n("9Nap")
...
var j=/([A-Z])/g,L=/^ms-/,B=b.Children.toArray,D={listing:!0,pre:!0,textarea:!0},U=/^[a-zA-Z][a-zA-Z:_\.\-\d]*$/,F={},q={}
var W={}
...
e=b.isValidElement(e)?e.type!==o?[e]:(e=e.props.children,b.isValidElement(e)?[e]:B(e)):B(e),this.stack=[{type:null,domNamespace:R,children:e,childIndex:0,context:W,footer:""}],this.exhausted=!1,this.currentSelectValue=null,this.previousWasTextNode=!1,this.makeStaticMarkup=t,this.contextIndex=-1,this.contextStack=[],this.contextValueStack=[]}return n.prototype.pushProvider=function(e){var t=++this.contextIndex,n=e.type._context,r=n._currentValue
...
r===a&&w("257"),w("258",r.toString())}return e=B(e),this.stack.push({type:null,domNamespace:n,children:e,childIndex:0,context:t,footer:""}),""}if("string"==typeof(r=e.type))return this.renderDOM(e,t,n)
switch(r){case i:case s:case c:case o:return e=B(e.props.children),this.stack.push({type:null,domNamespace:n,children:e,childIndex:0,context:t,footer:""}),""}if("object"==typeof r&&null!==r)switch(r.$$typeof){case d:return e=B(r.render(e.props,e.ref)),this.stack.push({type:null,domNamespace:n,children:e,childIndex:0,context:t,footer:""}),""
case u:return n={type:e,domNamespace:n,children:r=B(e.props.children),childIndex:0,context:t,footer:""},this.pushProvider(e),this.stack.push(n),""
case l:return r=B(e.props.children(e.type._currentValue)),this.stack.push({type:e,domNamespace:n,children:r,childIndex:0,context:t,footer:""}),""}w("130",null==r?r:typeof r,"")},n.prototype.renderDOM=function(e,t,n){var r=e.type.toLowerCase()
...
else{var v=m.replace(j,"-$1").toLowerCase().replace(L,"-ms-")
...
break e}i=null}return null!=i?(a=[],D[r]&&"\n"===i.charAt(0)&&(g+="\n"),g+=i):a=B(a.children),e=e.type,n=null==n||"http://www.w3.org/1999/xhtml"===n?N(e):"http://www.w3.org/2000/svg"===n&&"foreignObject"===e?"http://www.w3.org/1999/xhtml":n,this.stack.push({domNamespace:n,type:r,children:a,childIndex:0,context:t,footer:o}),this.previousWasTextNode=!1,g},n}(),X={renderToString:function(e){return new Z(e,!1).read(1/0)},renderToStaticMarkup:function(e){return new Z(e,!0).read(1/0)},renderToNodeStream:function(
){w("207")},renderToStaticNodeStream:function(){w("208")},version:"16.5.2"},J=X
e.exports=J.default||J},IOzZ:function(e,t){e.exports=function(t,n){return function(e){return null!=e&&e[t]===n&&(void 0!==n||t in Object(e))}}},IT1M:function(e,t,n){"use strict"
Object.defineProperty(t,"__esModule",{value:!0})
var r=n("JGuq")
...
return a.style.height=i+"px",o.style.height=c+"px",n.style.height=e.height-(i+c)+"px",Object.assign(r.style,{height:e.height+"px",marginTop:-i+"px"}),{$screen:t,$sheader:a,$sfooter:o,$scontainer:r}}},{key:"renderScreenContent",value:function(e,t,n,r){var a=this.updateScreenContentHeight(e),o=a.$screen,i=a.$sheader,c=a.$sfooter,u=a.$scontainer,l=(0,g.getScreenWidgetsMap)(Widget.irecords),s=(0,b.getItemsWithPrevData)(e,n,t,l),d=(0,y.generateTreeData)(s,e.cid).widgetTreeData;(m.default.render(
h.default.createElement(v.default,{widgetTreeData:d}),u),m.default.render(h.default.createElement(w,{treeData:d,headerHeight:e.headerHeight()}),i),m.default.render(h.default.createElement(S,{treeData:d,footerHeight:e.footerHeight(),screenHeight:e.height}),c),r)&&Array.from(o.querySelectorAll(".widget, .group, .panel")).forEach(function(e){return e.style.transition=r})
o.offsetWidth
...
0,m.default)((0,h.default)((0,h.default)(l)),"onInvite",function(){var e=l.props.host,t=l.state.formData,n=t.email,r=t.role,a=e.limitation,o=void 0===a?MB.user.limitation:a,i=e.collaborators(),c=void 0!==i.find(function(e){return e.email===n}),u=n&&_.EMAIL_REG.test(n)?n===MB.user.email?I18N.cant_invite_yourself:c?I18N.already_invited:i.length>o.collaborators?l.errorMsg():null:I18N.invalid_email
...
var r=n("xI34"),a=n("aFF0"),o=n("CoAX"),i=n("Clcl")
...
var B=r(n("lSNA")),a=n("XrEr"),D=n("qOCw")
t.transfromProptype=function(e){var t=e.attr,n=e.language,r=e.unit,a=(0,D.selectWithlanguageUnit)(n),o=t.width,i=t.height,c=t.lineHeight,u=t.opacity,l=t.borderRadius,s=t.borderWidth,d=t.borderColor,f=t.backgroundColor,p=t.color,h=t.fontSize,m=t.fontFamily,v=t.fontStyle,g=t.boxShadow,y=t.textAlign,b=t.x,w=t.y,S=b&&(0,B.default)({},F[a].x,U(b,r,a)),E=w&&(0,B.default)({},F[a].y,U(w,r,a)),C=o&&(0,B.default)({},F[a].width,U(o,r,a)),_=i&&(0,B.default)({},F[a].height,U(i,r,a)),x=c&&(0,B.default)({},F[a].lineHeight
,U(c,r,a)),k=u&&(0,B.default)({},F[a].opacity,U(u,r,a)),M=l&&(0,B.default)({},F[a].borderRadius,U(l,r,a)),T=f&&(0,B.default)({},F[a].backgroundColor,U(f,r,a,!0)),R=p&&(0,B.default)({},F[a].color,U(p,r,a,!0)),N=h&&(0,B.default)({},F[a].fontSize,U(h,r,a)),O=m&&(0,B.default)({},F[a].fontFamily,U(m,r,a)),I=v&&(0,B.default)({},F[a].fontStyle,U(v,r,a)),P=g&&(0,B.default)({},F[a].shadows,g),A=s&&(0,B.default)({},F[a].borderWidth,U(s,r,a)),j=d&&(0,B.default)({},F[a].borderColor,U(d,r,a,!0)),L=y&&(0,B.default)({},
F[a].textAlign,y)
return Object.assign({},S,E,C,_,x,k,M,A,j,T,R,N,I,L,P,O)}
...
if(!r)return-1
var a=null==n?0:c(n)
return a<0&&(a=u(r+a,0)),o(e,i(t,3),a)}},Uq06:function(e,t,n){"use strict"
var r=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.isPastedDataFromMB=t.getHTML=t.genSpanStyle=t.genParaStyle=void 0
var T=r(n("J4zp")),R=n("lMIk"),N=n("v4Lw"),o=n("FkXu"),a=n("j+XH"),O=function(e){return Object.entries(e).map(function(e){var t,n=(0,T.default)(e,2),r=n[0],a=n[1]
return"".concat((t=r,t.replace(/[A-Z]/g,function(e){return"-".concat(e.toLowerCase())})),":").concat(a,";")}).join(" ")},I=function(e){return{lineHeight:0,marginBottom:e.paraSpacing+"px"}}
t.genParaStyle=I
var i=/modao.cc/.test(window.MBServer)?function(e,t){return a.WESTERN_ONLY_FONT_LIST.includes(e)?"".concat(e,", ").concat(a.PLATFORM_DEFAULT_FONT["zh-CN"][t],", sans-serif"):"".concat(e,", sans-serif")}:function(e){return e},P=function(e,t){var n=(0,R.getSingleSpanAttr)(e,"fontFamily"),r=(0,R.getSingleSpanAttr)(e,"fontWeight"),a=(0,R.getSingleSpanAttr)(e,"boldType")
return{fontFamily:i(n,t),fontWeight:(0,o.getFontWeightNumDepandOnBoldType)(r,a),fontSize:(0,R.getSingleSpanAttr)(e,"fontSize")+"px",color:(0,R.getSingleSpanAttr)(e,"color"),fontStyle:(0,R.getSingleSpanAttr)(e,"fontStyle"),letterSpacing:(0,R.getSingleSpanAttr)(e,"letterSpacing")+"px",lineHeight:(0,R.getSingleSpanAttr)(e,"lineHeight")+"px",textDecoration:(0,R.getSingleSpanAttr)(e,"textDecoration")}}
t.genSpanStyle=P
t.getHTML=function(e,t,n){for(var r=MB.currentProject.device,a="",o=t||{start:[0,0,0],end:[]},i=(0,T.default)(o.start,3),c=i[0],u=i[1],l=i[2],s=(0,T.default)(o.end,3),d=s[0],f=s[1],p=s[2],h=[],m=c;;m++){for(var v=e[m],g=[],y=m===c,b=m===d,w=m===c?u:0;;w++){var S=y&&w===u,E=b&&w===f,C=v.children[w],_=C.text.slice(S?l:0,E?p:C.text.length),x=(0,N.getEscapedText)(_)
if(g.push('<span class="'.concat(A,'" data-boldtype="').concat((0,R.getSingleSpanAttr)(C,"boldType"),'" style="').concat(O(P(C,r)),'">').concat(""===C.text?"<br>":x,"</span>")),n&&(a+=_),w===(E?f:v.children.length-1))break}var k=g.join("")
if(h.push('<p style="'.concat(O(I(v)),'">').concat(k,"</p>")),n&&m!==d&&(a+="\n"),m===(b?d:e.length-1))break}var M=h.join("")
return n?{text:a,HTML:M}:M}
var A="--mb--rich-text--"
t.isPastedDataFromMB=function(e){return new RegExp(A).test(e)}},Ur7v:function(e,t,n){"use strict"
var r=n("284h"),a=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
...
var s=r(n("o0o1")),a=r(n("yXPU")),u=n("CoAX"),d=n("os03"),f=n("ycqN"),p=window.MB
...
case 6:case"end":return e.stop()}},e,this)}))
return function(e,t){return n.apply(this,arguments)}}()
t.onFallbackError=l},WF1K:function(e,t,n){"use strict"
Object.defineProperty(t,"__esModule",{value:!0}),t.MONO_FONT=t.default=void 0
var r={fontFamily:"Arial",fontWeight:"regular",fontSize:14,color:"#101010",fontStyle:"normal",textDecoration:"none",letterSpacing:0}
t.default=r
t.MONO_FONT="Courier New"},WVP6:function(e,t,n){"use strict"
Object.defineProperty(t,"__esModule",{value:!0})
...
var u=o.toolbarActiveItem,l=o.isFullScreenMode,s=u==T.PREVIEW,d=u==T.INSPECT,f=u==T.COMMENT,p=!O.isElectron()&&!O.isHTMLZip()&&d&&c&&D(),h=!a&&s&&(P.has(r)||i),m=R({"is-offline-mode":O.isHTMLZip(),"is-uichina":O.isUIChina()||O.isForum(),"full-screen":l})
...
)&&v.default.createElement("a",{className:"powered-by",href:"/",target:"_blank"},v.default.createElement("img",{className:"zh",src:"/images/preview/watermark_zh.svg",alt:I.preview.powered_by_modao}),v.default.createElement("img",{className:"en",src:"/images/preview/watermark_en.svg",alt:I.preview.powered_by_modao})),v.default.createElement(j,{isActive:p,onClick:this.handleClick}),s&&v.default.createElement(M.default,null),v.default.createElement(x.default,null))}}]),r}(v.Component)
t.default=A,(0,d.default)(A,"propTypes",{isLite:f.default.bool,project:f.default.object,previewSetting:f.default.object,layer:f.default.object,isProjectFromOtherFreeUser:f.default.bool,userId:f.default.number,dispatch:f.default.func})
var j=function(e){var t=e.isActive,n=e.onClick
...
j.propTypes={isActive:f.default.bool.isRequired,onClick:f.default.func.isRequired}
var L=function(e){var t=e.project,n=e.isProjectFromOtherFreeUser
return console.log(t)&&(0,_.setProjectCommentPermission)({allowComment:!(t.combo||t.template)&&t.isCommentable(),denyMessage:O.renewMsg("cant_comment",{role:n?t.team_cid?"team":"project":"user"})})},B="close_client_load_tip",D=function(){return!O.localStorageDelegate.getItem(B)},U=function(){return O.localStorageDelegate.setItem(B,"true")}},a1Ia:function(e,t,n){e.exports={"sub-toolbar":"_1_GW4ZPKsACMqmFUgNIiea","select-input":"_1z2tl9KzoQhfo9Vd0AnQNl"}},aFF0:function(e,t,n){"use strict"
...
t.SliceContainer=j},gX9a:function(e,t,n){e.exports={"play-setting-menu":"_1FA8P7EgiQtr3ukFbj9cuo"}},gXld:function(e,t,n){"use strict"
var r=n("284h"),a=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
...
t.CopyBtn=y,(0,d.default)(y,"propTypes",{target:p.default.string,text:p.default.string})},hFiN:function(e,t,n){"use strict"
Object.defineProperty(t,"__esModule",{value:!0}),t.getAutoHeight=t.getAutoSize=void 0
var r=n("CoAX")
t.getAutoSize=function(e){return"rich_text"===e.name?{width:e.initialWidth(r.getHTML),height:e.initialHeight(r.getHTML)}:{width:e.width,height:e.height}}
t.getAutoHeight=function(e){return"rich_text"===e.name?e.autoHeightForFixedWidth(r.getHTML):e.height}},hgQt:function(e,t,n){var r=n("Juji"),a=n("4sDh")
...
var r=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
var Ie=r(n("MVZn")),a=r(n("17x9")),Pe=r(n("q1tI")),Ae=n("qOCw"),je=n("Ro3d"),Le=n("PqLM"),Be=n("RUem"),o=function(e){var t=e.layer,n=e.unit,r=e.ratio,a=e.showGlobal,o=e.userPickColor,i=void 0===o?[]:o,c=e.globalColor,u=void 0===c?[]:c,l=e.globalText,s=void 0===l?[]:l,d=e.documentColor,f=void 0===d?[]:d,p=e.screenColor,h=void 0===p?[]:p,m=e.language,v=e.colorUnit,g=e.dispatch,y=t.src_left,b=t.src_top,w=t.src_width,S=t.src_height,E=t.origin_width,C=t.origin_height,_=t.bd_radius,x=t.line_height,k=t.bg_colors,
M=void 0===k?[]:k,T=t.borders,R=void 0===T?[]:T,N=t.i,O=t.display_name,I=t.padding,P=void 0===I?0:I,A=t.hiddSpacing,j=void 0!==A&&A,L=t.text_styles,B=void 0===L?[]:L,D=t.alignment,U=t.vertical_alignment,F=t.image,q=t.text,W=t.letter_spacing,H=t.image_set_zip,z=t.shadows,V=void 0===z?[]:z,Y=t.inner_shadows,Z=void 0===Y?[]:Y,X=t.rotation,J=t.textShadows,G=void 0===J?[]:J,K=t.image_set,Q=void 0===K?[]:K,$=t.name,ee=0<R.length,te=0<M.length,ne=!!F,re=0<B.length&&q&&(0,Ae.getTextContent)(t).length,
ae=0<V.length||0<G.length,oe=0<Z.length,ie=H,ce={left:y,top:b,width:E||w,height:C||S,borderRadius:_,opacity:t.o,rotation:X,ratio:r,unit:n}
if("line"===$){var ue=(0,Le.getLineGeneralInfo)(t,!0),le=ue.length,se=ue.thickness,de=ue.angle
ce.width=le,ce.height=se,ce.rotation=de}var fe=(0,Ae.getBaseAttributes)(ce),pe=fe.adapterTop,he=fe.adapterLeft,me=fe.adapterWidth,ve=fe.adapterHeight,ge=fe.radius,ye=fe.opacity,be=fe.rotate,we={lineHeight:x,letterSpacing:W,unit:n,ratio:r},Se=(0,Ae.getTextAttributes)(we),Ee=Se.lineHeight,Ce=Se.letterSpacing,_e="number"==typeof N?N?"italic":"normal":void 0,xe={textStyles:B,background:M,borders:R,shadows:V,innerShadows:Z,colorUnit:v,ratio:r,unit:n},ke=(0,Ae.getCodeAttributes)(xe),Me=t.o&&100!=t.o?t.o/100:null,
Te=(0,je.transfromProptype)({attr:(0,Ie.default)({x:he,y:pe,width:me,height:ve,lineHeight:Ee,textAlign:D,opacity:Me,borderRadius:ge},ke),language:m,unit:n}),Re=ne?"ImageView":re?"TextView":"View",Ne="screen"===t.type||t.kind?t.name:O,Oe="line"===t.name
return a?Pe.default.createElement(Be.GlobalAttributes,{adapterWidth:me,adapterHeight:ve,documentColor:f,globalText:s,globalColor:u,screenColor:h,userPickColor:i,colorUnit:v,dispatch:g}):Pe.default.createElement("div",null,Pe.default.createElement(Be.LayerName,{value:Ne}),Pe.default.createElement(Be.BasicAttributes,{adapterTop:pe,adapterLeft:he,adapterWidth:me,adapterHeight:ve,rotate:be,radius:ge,opacity:ye,unit:n,colorUnit:v}),re&&Pe.default.createElement(Be.TextLayerInfo,{textStyles:B,alignment:D,
vertical_alignment:U,lineHeight:Ee,letterSpacing:Ce,ratio:r,unit:n,o:t.o,padding:P,fontStyle:_e,colorUnit:v,hiddSpacing:j,text:(0,Ae.getTextContent)(t)}),te&&Pe.default.createElement(Be.Fills,{backgroundColorSort:M,colorUnit:v}),ee&&Pe.default.createElement(Be.BorderInfo,{isStroke:Oe,borderSort:R,ratio:r,unit:n,colorUnit:v}),ae&&Pe.default.createElement(Be.Shadows,{shadows:V,textShadows:G,colorUnit:v,unit:n,ratio:r}),oe&&Pe.default.createElement(Be.Shadows,{shadows:Z,colorUnit:v,unit:n,ratio:r,
isInnerShaow:!0}),ie&&Pe.default.createElement(Be.ImageInfo,{imageSetZip:H,name:t.display_name,imageSet:Q}),Pe.default.createElement(Be.CodeBox,{code:Te,whichAndView:Re,language:m,text:(0,Ae.getTextContent)(t)||""}))}
...
var m=r(n("MVZn")),i=r(n("cl8F")),s=n("CoAX"),c=n("Ibie"),d=n("FkXu"),o=n("/5+U"),u=n("upRB"),y=/\\\w+/gi,b=function(e){return e?e.replace(y,"").trim():i.default}
t.checkColor=b
...
return Screen.find(t)}},lMIk:function(e,t,n){"use strict"
var r=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.getRichTextAttr=t.getSingleSpanAttr=t.SPAN_ATTRS=void 0
var a=r(n("WF1K"))
t.SPAN_ATTRS=["fontFamily","fontWeight","fontSize","color","fontStyle","textDecoration","letterSpacing","lineHeight"]
var i=function e(t,n){if("fontFamily"===n)return t.fontFamily||a.default.fontFamily
if("fontWeight"===n)return t.fontWeight||a.default.fontWeight
if("boldType"===n)return Number(t.boldType)?1:0
if("fontSize"===n)return t.fontSize||a.default.fontSize
if("color"===n)return t.color||a.default.color
if("fontStyle"===n)return t.fontStyle||a.default.fontStyle
if("textDecoration"===n)return t.textDecoration||a.default.textDecoration
if("letterSpacing"===n)return t.letterSpacing||a.default.letterSpacing
if("lineHeight"===n){var r=t.lineHeight
return r&&"normal"!==r?r:Widget.getNormalLineHeight(e(t,"fontFamily"),e(t,"fontSize"))}}
t.getSingleSpanAttr=i
var o=function(e){var t=1<arguments.length&&void 0!==arguments[1]?arguments[1]:[0,0],n=2<arguments.length?arguments[2]:void 0,r=t[0],a=t[1],o=e[r].children[a]
return i(o,n)}
t.getRichTextAttr=function(e,t,n){if(!e)return null
var r={fontFamily:o(e,t,"fontFamily"),fontWeight:o(e,t,"fontWeight"),boldType:o(e,t,"boldType"),fontSize:o(e,t,"fontSize"),color:o(e,t,"color"),fontStyle:o(e,t,"fontStyle"),textDecoration:o(e,t,"textDecoration"),letterSpacing:o(e,t,"letterSpacing"),lineHeight:o(e,t,"lineHeight"),paraSpacing:function(e){var t=1<arguments.length&&void 0!==arguments[1]?arguments[1]:[0]
if("paraSpacing"===(2<arguments.length?arguments[2]:void 0))return e[t[0]].paraSpacing}(e,t,"paraSpacing")}
return n?r[n]:r}},"lm/5":function(e,t,n){var p=n("fmRc"),h=n("wF/u")
...
n.r(t)
var r=n("tw9P")
n.d(t,"take",function(){return r.s}),n.d(t,"takem",function(){return r.v}),n.d(t,"put",function(){return r.n}),n.d(t,"all",function(){return r.b}),n.d(t,"race",function(){return r.o}),n.d(t,"call",function(){return r.e}),n.d(t,"apply",function(){return r.c}),n.d(t,"cps",function(){return r.h}),n.d(t,"fork",function(){return r.k}),n.d(t,"spawn",function(){return r.r}),n.d(t,"join",function(){return r.m}),n.d(t,"cancel",function(){return r.f}),n.d(t,"select",function(){return r.p}),n.d(t,"actionChannel",
function(){return r.a}),n.d(t,"cancelled",function(){return r.g}),n.d(t,"flush",function(){return r.j}),n.d(t,"getContext",function(){return r.l}),n.d(t,"setContext",function(){return r.q}),n.d(t,"takeEvery",function(){return r.t}),n.d(t,"takeLatest",function(){return r.u}),n.d(t,"throttle",function(){return r.w})},oose:function(e,t,n){"use strict"
var r=n("TqRt")
...
var h=r(n("J4zp")),p=r(n("o0o1")),m=r(n("yXPU"))
...
var v=function(){}
t.createSaveQueue=function(e){var t=e.onError,a=e.doSave,n=e.beforeSave,o=void 0===n?v:n,r=e.afterSave,i=void 0===r?v:r,c=[],u=!1,l={},s=function(e){l=e},d=(f=(0,m.default)(p.default.mark(function e(){var t,n,r
return p.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return o(),t=c,c=[],u=!0,e.next=6,g(a,t,s)
...
var g=function(){var t=(0,m.default)(p.default.mark(function e(t){var n,r,a,o,i,c=arguments
...
var a=function(){var t=(0,m.default)(p.default.mark(function e(t){var n,r,a,o,i,c
...
t.fetchLikeRequest=function(f){var p=1<arguments.length&&void 0!==arguments[1]?arguments[1]:{}
return new Promise(function(i,c){var e=p.method,n=void 0===e?"GET":e,t=p.headers,r=p.body,a=p.timeout,o=void 0===a?6e4:a,u=function(e,t){return Object.assign(new Error(e),{status:t,url:f,method:n})},l=new XMLHttpRequest,s=!1,d=function(){!s&&l.abort(),c(u("NETWORK_TIMEOUT",-1)),s=!0}
l.open(n,f),t&&Object.entries(t).forEach(function(e){var t=(0,h.default)(e,2),n=t[0],r=t[1]
return l.setRequestHeader(n,r)}),l.timeout=Number(o)||0,l.responseType="text",l.onerror=function(){c(u("NETWORK_ERROR",-1)),s=!0},l.ontimeout=d,l.onreadystatechange=function(){var e=l.readyState,t=l.status
if(2===e){if(s=!0,0===t)return c(u("STATUS_ERROR",-1))
var n=200<=t&&t<300,r=y(l,u),a=r.text,o=r.json
i({status:t,ok:n,text:a,json:o})}},l.send(r||null),o&&setTimeout(d,o)})}
var y=function(a,o){var e,t=!1
setTimeout(function(){e||(a.abort(),t=!0)})
var n=function(){if(void 0===e){if(t)throw o("PAYLOAD_ALREADY_DROPPED",-1)
e=new Promise(function(n,r){a.onerror=function(){return r(o("PAYLOAD_ERROR",-1))},a.ontimeout=function(){return r(o("PAYLOAD_TIMEOUT",-1))},a.onreadystatechange=function(){var e=a.readyState,t=a.status
if(4===e)return 0===t?r(o("PAYLOAD_STATUS_ERROR",-1)):void n(a.response)}})}return e}
return{text:n,json:function(){return n().then(function(e){return JSON.parse(e)})}}}},p2ZH:function(e,t,n){"use strict"
var r=n("284h"),a=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
...
t.default=m,(0,s.default)(m,"propTypes",{screen:d.default.object,screenInOrder:d.default.array,shouldTextShow:d.default.bool,reachFirstScreen:d.default.bool,reachLastScreen:d.default.bool})},p7Sh:function(e,t,n){e.exports={"thumbnail-container":"_1iU7yzdbdyvTcm4cDCjwwm"}},peLG:function(e,t,n){},peh1:function(e,t,n){"use strict"
function a(e,t){return e===t}function s(e){var t=1<arguments.length&&void 0!==arguments[1]?arguments[1]:a,n=null,r=null
...
return!0}(t,n,arguments)||(r=e.apply(null,arguments)),n=arguments,r}}function r(u){for(var e=arguments.length,l=Array(1<e?e-1:0),t=1;t<e;t++)l[t-1]=arguments[t]
...
throw new Error("Selector creators expect all input-selectors to be functions, instead received the following types: ["+n+"]")}(t),i=u.apply(void 0,[function(){return r++,a.apply(null,arguments)}].concat(l)),c=s(function(){for(var e=[],t=o.length,n=0;n<t;n++)e.push(o[n].apply(null,arguments))
return i.apply(null,e)})
return c.resultFunc=a,c.recomputations=function(){return r},c.resetRecomputations=function(){return r=0},c}}t.__esModule=!0,t.defaultMemoize=s,t.createSelectorCreator=r,t.createStructuredSelector=function(t){var e=1<arguments.length&&void 0!==arguments[1]?arguments[1]:o
...
var o=t.createSelector=r(s)},prTy:function(e,t,n){"use strict"
var r=n("284h"),a=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
...
var l=r(n("o0o1")),a=r(n("yXPU")),s=n("t3Un"),o=n("CoAX"),i=window,c=i.$,d=i.MB,f=i.Screen,u=i.Screenstate,p=i.Panel,h=i.Panelstate,m=i.Widget,v=i.Widgetstate,g=i.Link
...
if(p)return l=setTimeout(v,a),h(s)}return void 0===l&&(l=setTimeout(v,a)),u}return a=w(a)||0,y(e)&&(f=!!e.leading,c=(p="maxWait"in e)?S(w(e.maxWait)||0,a):c,t="trailing"in e?!!e.trailing:t),n.cancel=function(){void 0!==l&&clearTimeout(l),o=s=i=l=void(d=0)},n.flush=function(){return void 0===l?u:g(b())},n}},sa7h:function(e,t,n){"use strict"
var r=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.genParasFromHTML=void 0
var l=r(n("MVZn")),a=n("FkXu"),o=n("lMIk"),s=function(e){return"marginTop"===e?"paraSpacing":e},d=function(i,c,e){var u={}
return o.SPAN_ATTRS.forEach(function(e){var t,n,r,a,o=(n=i[t=e],r=s(t),a=n.replace(/'|"/g,""),["fontSize","lineHeight","letterSpacing","paraSpacing"].includes(r)&&"px"===a.slice(-2)&&(a=Number(a.slice(0,-2))),a||c[e])
u[e]=o}),u.fontFamily=(u.fontFamily||"").split(",")[0].trim(),u.fontWeight=(0,a.getFontWeightStrDepandOnBoldType)(u.fontWeight,c.fontWeight,e),u}
t.genParasFromHTML=function(e,u){var t=Array.from(e.getElementsByTagName("p"))
return 0===t.length?[{paraSpacing:u.paraSpacing,children:[(0,l.default)({},u.child,{text:""})]}]:t.map(function(e,t,n){var r,a,o,i,c=Array.from(e.getElementsByTagName("span"))
return r=0===c.length?[(0,l.default)({},u.child,{text:""})]:c.map(function(e){return(0,l.default)({text:e.innerText,boldType:Number(e.dataset.boldtype)?1:0},d(e.style,u.child,Number(e.dataset.boldtype)))}),{paraSpacing:(a=t,o=n,i=a===o.length-1&&1<o.length?a-1:a,Number(o[i].style.marginBottom.replace("px",""))),children:r}})}},seXi:function(e,t,n){var b=n("qZTm"),w=Object.prototype.hasOwnProperty
...
t.renderPngDataUrlFromSvgDataUrl=A},tBsX:function(e,t,n){"use strict"
var r=n("TqRt")
...
n.d(t,"i",function(){return C}),n.d(t,"s",function(){return _}),n.d(t,"v",function(){return x}),n.d(t,"n",function(){return k}),n.d(t,"b",function(){return M}),n.d(t,"o",function(){return T}),n.d(t,"e",function(){return N}),n.d(t,"c",function(){return O}),n.d(t,"h",function(){return I}),n.d(t,"k",function(){return P}),n.d(t,"r",function(){return A}),n.d(t,"m",function(){return j}),n.d(t,"f",function(){return L}),n.d(t,"p",function(){return B}),n.d(t,"a",function(){return D}),n.d(t,"g",function(){return U}),
n.d(t,"j",function(){return F}),n.d(t,"l",function(){return q}),n.d(t,"q",function(){return W}),n.d(t,"t",function(){return H}),n.d(t,"u",function(){return z}),n.d(t,"w",function(){return V}),n.d(t,"d",function(){return Z})
var i=n("Ev6p"),c=n("q09E"),r=Object(i.x)("IO"),a="TAKE",o="PUT",u="ALL",l="RACE",s="CALL",d="CPS",f="FORK",p="JOIN",h="CANCEL",m="SELECT",v="ACTION_CHANNEL",g="CANCELLED",y="FLUSH",b="GET_CONTEXT",w="SET_CONTEXT",S="\n(HINT: if you are getting this errors in tests, consider using createMockTask from redux-saga/utils)",E=function(e,t){var n
return(n={})[r]=!0,n[e]=t,n},C=function(e){return Object(i.h)(Z.fork(e),i.q.object,"detach(eff): argument must be a fork effect"),e[f].detached=!0,e}
function _(){var e=0<arguments.length&&void 0!==arguments[0]?arguments[0]:"*"
if(arguments.length&&Object(i.h)(arguments[0],i.q.notUndef,"take(patternOrChannel): patternOrChannel is undefined"),i.q.pattern(e))return E(a,{pattern:e})
if(i.q.channel(e))return E(a,{channel:e})
throw new Error("take(patternOrChannel): argument "+String(e)+" is not valid channel or a valid pattern")}_.maybe=function(){var e=_.apply(void 0,arguments)
return e[a].maybe=!0,e}
var x=Object(i.n)(_.maybe,Object(i.z)("takem","take.maybe"))
function k(e,t){return 1<arguments.length?(Object(i.h)(e,i.q.notUndef,"put(channel, action): argument channel is undefined"),Object(i.h)(e,i.q.channel,"put(channel, action): argument "+e+" is not a valid channel"),Object(i.h)(t,i.q.notUndef,"put(channel, action): argument action is undefined")):(Object(i.h)(e,i.q.notUndef,"put(action): argument action is undefined"),t=e,e=null),E(o,{channel:e,action:t})}function M(e){return E(u,e)}function T(e){return E(l,e)}function R(e,t,n){Object(i.h)(t,i.q.notUndef,
...
return E(s,R("call",e,n))}function O(e,t){var n=2<arguments.length&&void 0!==arguments[2]?arguments[2]:[]
return E(s,R("apply",{context:e,fn:t},n))}function I(e){for(var t=arguments.length,n=Array(1<t?t-1:0),r=1;r<t;r++)n[r-1]=arguments[r]
return E(d,R("cps",e,n))}function P(e){for(var t=arguments.length,n=Array(1<t?t-1:0),r=1;r<t;r++)n[r-1]=arguments[r]
return E(f,R("fork",e,n))}function A(e){for(var t=arguments.length,n=Array(1<t?t-1:0),r=1;r<t;r++)n[r-1]=arguments[r]
return C(P.apply(void 0,[e].concat(n)))}function j(){for(var e=arguments.length,t=Array(e),n=0;n<e;n++)t[n]=arguments[n]
if(1<t.length)return M(t.map(function(e){return j(e)}))
var r=t[0]
return Object(i.h)(r,i.q.notUndef,"join(task): argument task is undefined"),Object(i.h)(r,i.q.task,"join(task): argument "+r+" is not a valid Task object "+S),E(p,r)}function L(){for(var e=arguments.length,t=Array(e),n=0;n<e;n++)t[n]=arguments[n]
if(1<t.length)return M(t.map(function(e){return L(e)}))
var r=t[0]
return 1===t.length&&(Object(i.h)(r,i.q.notUndef,"cancel(task): argument task is undefined"),Object(i.h)(r,i.q.task,"cancel(task): argument "+r+" is not a valid Task object "+S)),E(h,r||i.d)}function B(e){for(var t=arguments.length,n=Array(1<t?t-1:0),r=1;r<t;r++)n[r-1]=arguments[r]
return 0===arguments.length?e=i.o:(Object(i.h)(e,i.q.notUndef,"select(selector,[...]): argument selector is undefined"),Object(i.h)(e,i.q.func,"select(selector,[...]): argument "+e+" is not a function")),E(m,{selector:e,args:n})}function D(e,t){return Object(i.h)(e,i.q.notUndef,"actionChannel(pattern,...): argument pattern is undefined"),1<arguments.length&&(Object(i.h)(t,i.q.notUndef,"actionChannel(pattern, buffer): argument buffer is undefined"),Object(i.h)(t,i.q.buffer,
"actionChannel(pattern, buffer): argument "+t+" is not a valid buffer")),E(v,{pattern:e,buffer:t})}function U(){return E(g,{})}function F(e){return Object(i.h)(e,i.q.channel,"flush(channel): argument "+e+" is not valid channel"),E(y,e)}function q(e){return Object(i.h)(e,i.q.string,"getContext(prop): argument "+e+" is not a string"),E(b,e)}function W(e){return Object(i.h)(e,i.q.object,Object(i.k)(null,e)),E(w,e)}function H(e,t){for(var n=arguments.length,r=Array(2<n?n-2:0),a=2;a<n;a++)r[a-2]=arguments[a]
return P.apply(void 0,[c.b,e,t].concat(r))}function z(e,t){for(var n=arguments.length,r=Array(2<n?n-2:0),a=2;a<n;a++)r[a-2]=arguments[a]
return P.apply(void 0,[c.d,e,t].concat(r))}function V(e,t,n){for(var r=arguments.length,a=Array(3<r?r-3:0),o=3;o<r;o++)a[o-3]=arguments[o]
return P.apply(void 0,[c.f,e,t,n].concat(a))}k.resolve=function(){var e=k.apply(void 0,arguments)
return e[o].resolve=!0,e},k.sync=Object(i.n)(k.resolve,Object(i.z)("put.sync","put.resolve"))
var Y=function(t){return function(e){return e&&e[r]&&e[t]}},Z={take:Y(a),put:Y(o),all:Y(u),race:Y(l),call:Y(s),cps:Y(d),fork:Y(f),join:Y(p),cancel:Y(h),select:Y(m),actionChannel:Y(v),cancelled:Y(g),flush:Y(y),getContext:Y(b),setContext:Y(w)}},u6S6:function(e,t,n){var r=n("6acW"),a=n("sgoq")(function(e,t,n){return t=t.toLowerCase(),e+(n?r(t):t)})
...
var r=n("284h"),a=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.getWidgetContent=function(e,t){switch(e.name){case"rich_text":return m.default.createElement(w,{widget:e})
case"text_field":case"nav_bar":case"navigation_bar":return m.default.createElement(S,{widget:e})
case"mtext_input":return m.default.createElement(E,{widget:e})
case"mtextarea":return m.default.createElement(C,{widget:e})
case"mcheckbox2":return m.default.createElement(_,{widget:e})
case"mfile_input":return m.default.createElement(x,{widget:e})
case"mradiobutton":return m.default.createElement(k,{widget:e})
case"mselect":return m.default.createElement(M,{widget:e})
case"button":return m.default.createElement(T,{widget:e})
case"hr":return m.default.createElement(R,{widget:e})
case"line":return m.default.createElement(N,{widget:e})
case"ve":return m.default.createElement(O,{widget:e})
case"triangleb":return m.default.createElement(I,{widget:e})
case"triangletl":return m.default.createElement(P,{widget:e})
case"lr":case"tab_bar":case"rectangle":return m.default.createElement(A,{widget:e})
case"image_view":return m.default.createElement(B,{widget:e})
case"webpage":return m.default.createElement(j,{widget:e,isPreview:t})
case"video_view":return m.default.createElement(L,{widget:e})
case"keyboard":return m.default.createElement(D,{widget:e})
case"iphone_keyboard":return m.default.createElement(U,{widget:e})
case"ipad_keyboard":return m.default.createElement(F,{widget:e})
case"android_keyboard":return m.default.createElement(q,{widget:e})
case"map_view":return m.default.createElement(W,{widget:e})
case"search_bar":return m.default.createElement(H,{widget:e})
case"status_bar":return m.default.createElement(z,{widget:e})
case"ios_status_bar":return m.default.createElement(V,{widget:e})
case"iphone_x_status_bar":return m.default.createElement(Y,{widget:e})
case"android_status_bar":return m.default.createElement(Z,{widget:e})
case"switch":case"ios_switch":return m.default.createElement(X,{widget:e})
case"android_switch":return m.default.createElement(J,{widget:e})
case"ios_check":return m.default.createElement(G,{widget:e})
case"android_check":return m.default.createElement(K,{widget:e})
case"android_radio":return m.default.createElement(Q,{widget:e})
case"tab_item":return m.default.createElement($,{widget:e})
case"pg":return m.default.createElement(ee,{widget:e})
case"icon_button":return m.default.createElement(te,{widget:e})
case"label":return m.default.createElement(ne,{widget:e})
case"circle_rect":case"rounded_rect":case"text_view":return m.default.createElement(re,{widget:e})
case"sticky":return m.default.createElement(ae,{widget:e})
case"mtooltip":return m.default.createElement(oe,{widget:e})
default:return null}}
var l=a(n("MVZn")),s=a(n("J4zp")),i=a(n("PJYZ")),d=a(n("lSNA")),c=a(n("lwsE")),u=a(n("W8MJ")),f=a(n("a1gu")),p=a(n("Nsbk")),h=a(n("7W2i")),o=a(n("17x9")),m=r(n("q1tI")),v=r(n("m/km")),g=n("rQun"),y=n("CoAX")
var b=function(e){function t(){return(0,c.default)(this,t),(0,f.default)(this,(0,p.default)(t).apply(this,arguments))}return(0,h.default)(t,e),(0,u.default)(t,[{key:"render",value:function(){return null}}]),t}(m.PureComponent)
b.propTypes={widget:o.default.object}
var w=function(e){function t(){return(0,c.default)(this,t),(0,f.default)(this,(0,p.default)(t).apply(this,arguments))}return(0,h.default)(t,e),(0,u.default)(t,[{key:"render",value:function(){var e=this.props.widget,t=JSON.parse(e.text)
return m.default.createElement("div",{className:"rich-text",dangerouslySetInnerHTML:{__html:(0,y.getHTML)(t)}})}}]),t}(b),S=function(e){function t(){return(0,c.default)(this,t),(0,f.default)(this,(0,p.default)(t).apply(this,arguments))}return(0,h.default)(t,e),(0,u.default)(t,[{key:"render",value:function(){var e=this.props.widget
return m.default.createElement("span",{className:"text"},e.text)}}]),t}(b),E=function(e){function t(){return(0,c.default)(this,t),(0,f.default)(this,(0,p.default)(t).apply(this,arguments))}return(0,h.default)(t,e),(0,u.default)(t,[{key:"render",value:function(){var e=this.props.widget
return m.default.createElement("input",{type:e.input_type,placeholder:e.text})}}]),t}(b),C=function(e){function t(){return(0,c.default)(this,t),(0,f.default)(this,(0,p.default)(t).apply(this,arguments))}return(0,h.default)(t,e),(0,u.default)(t,[{key:"render",value:function(){var e=this.props.widget,t=Math.round(e.padding*e.s()/100),n=Math.round(t-(e.lh-e.fs)/2)
n<0&&(n=0)
var r={padding:"".concat(n,"px ").concat(t,"px")}
return m.default.createElement("textarea",{style:r,placeholder:e.text})}}]),t}(b),_=function(e){function t(){return(0,c.default)(this,t),(0,f.default)(this,(0,p.default)(t).apply(this,arguments))}return(0,h.default)(t,e),(0,u.default)(t,[{key:"render",value:function(){var e=this.props.widget
return m.default.createElement("input",{type:"checkbox",checked:e.checked})}}]),t}(b),x=function(e){function t(){return(0,c.default)(this,t),(0,f.default)(this,(0,p.default)(t).apply(this,arguments))}return(0,h.default)(t,e),(0,u.default)(t,[{key:"render",value:function(){return m.default.createElement("input",{type:"file"})}}]),t}(b),k=function(e){function t(){return(0,c.default)(this,t),(0,f.default)(this,(0,p.default)(t).apply(this,arguments))}return(0,h.default)(t,e),(0,u.default)(t,[{key:"render",
value:function(){var e=this.props.widget
return m.default.createElement("input",{type:"radio",name:e.gid,checked:e.checked})}}]),t}(b),M=function(e){function t(){return(0,c.default)(this,t),(0,f.default)(this,(0,p.default)(t).apply(this,arguments))}return(0,h.default)(t,e),(0,u.default)(t,[{key:"render",value:function(){var e=this.props.widget
return m.default.createElement("select",null,e.text.split(/\n/).map(function(e,t){return m.default.createElement("option",{key:e+t},e)}))}}]),t}(b),T=function(e){function t(){return(0,c.default)(this,t),(0,f.default)(this,(0,p.default)(t).apply(this,arguments))}return(0,h.default)(t,e),(0,u.default)(t,[{key:"render",value:function(){var e=this.props.widget
return m.default.createElement("div",{className:"button-wrapper"},e.icon?(0,g.getIcon)(e):null,m.default.createElement("span",{className:"text"},e.text))}}]),t}(b),R=function(e){function t(){return(0,c.default)(this,t),(0,f.default)(this,(0,p.default)(t).apply(this,arguments))}return(0,h.default)(t,e),(0,u.default)(t,[{key:"render",value:function(){var e=this.props.widget,t=e.h()-10*e.s()/100
return t<1&&(t=1),m.default.createElement("span",{style:{borderTopWidth:t}})}}]),t}(b),N=function(e){function o(){var e,t;(0,c.default)(this,o)
for(var n=arguments.length,r=new Array(n),a=0;a<n;a++)r[a]=arguments[a]
...
return m.default.createElement("svg",{style:{overflow:"visible",filter:e||"none"}},m.default.createElement("path",{d:d,stroke:o,strokeWidth:a,strokeDasharray:f}),m.default.createElement("path",{d:d,stroke:"transparent",strokeWidth:"10",style:{pointerEvents:"auto"}}))}}]),o}(b),O=function(e){function t(){return(0,c.default)(this,t),(0,f.default)(this,(0,p.default)(t).apply(this,arguments))}return(0,h.default)(t,e),(0,u.default)(t,[{key:"render",value:function(){var e=this.props.widget,t=e.w()-10*e.s()/100
return t<1&&(t=1),m.default.createElement("span",{style:{borderLeftWidth:t}})}}]),t}(b),I=function(e){function t(){return(0,c.default)(this,t),(0,f.default)(this,(0,p.default)(t).apply(this,arguments))}return(0,h.default)(t,e),(0,u.default)(t,[{key:"render",value:function(){var e=this.props.widget,t="M "+[[e.width/2,0],[e.width,e.height],[0,e.height]].map(function(e){return e.join(" ")}).join(" L ")+" Z"
return m.default.createElement("svg",{xmlns:"http://www.w3.org/2000/svg"},m.default.createElement("path",{d:t}))}}]),t}(b),P=function(e){function t(){return(0,c.default)(this,t),(0,f.default)(this,(0,p.default)(t).apply(this,arguments))}return(0,h.default)(t,e),(0,u.default)(t,[{key:"render",value:function(){var e=this.props.widget,t="M "+[[0,0],[e.width,0],[0,e.height]].map(function(e){return e.join(" ")}).join(" L ")+" Z"
return m.default.createElement("svg",{xmlns:"http://www.w3.org/2000/svg"},m.default.createElement("path",{d:t}))}}]),t}(b),A=function(e){function t(){return(0,c.default)(this,t),(0,f.default)(this,(0,p.default)(t).apply(this,arguments))}return(0,h.default)(t,e),(0,u.default)(t,[{key:"render",value:function(){return m.default.createElement("span",null)}}]),t}(b),j=function(e){function o(){var e,t;(0,c.default)(this,o)
for(var n=arguments.length,r=new Array(n),a=0;a<n;a++)r[a]=arguments[a]
...
return m.default.createElement("img",{src:a,className:"keyboard-img",alt:"keyboard",draggable:!1})}}]),t}(b),U=function(e){function t(){return(0,c.default)(this,t),(0,f.default)(this,(0,p.default)(t).apply(this,arguments))}return(0,h.default)(t,e),(0,u.default)(t,[{key:"render",value:function(){var e=this.props.widget,t=e.numeric?"n":"r",n=e.cs().orientation,r="".concat(MB.urlRootHTMLZip(),"images/keyboards/iphone_").concat(t,"_").concat(n,".png")
return m.default.createElement("img",{src:r,className:"keyboard-img",alt:"keyboard",draggable:!1})}}]),t}(b),F=function(e){function t(){return(0,c.default)(this,t),(0,f.default)(this,(0,p.default)(t).apply(this,arguments))}return(0,h.default)(t,e),(0,u.default)(t,[{key:"render",value:function(){var e=this.props.widget,t=e.numeric?"n":"r",n=e.cs().orientation,r="".concat(MB.urlRootHTMLZip(),"images/keyboards/ipad_").concat(t,"_").concat(n,".png")
return m.default.createElement("img",{src:r,className:"keyboard-img",alt:"keyboard",draggable:!1})}}]),t}(b),q=function(e){function t(){return(0,c.default)(this,t),(0,f.default)(this,(0,p.default)(t).apply(this,arguments))}return(0,h.default)(t,e),(0,u.default)(t,[{key:"render",value:function(){var e=this.props.widget,t=e.numeric?"n":"r",n=e.cs().orientation,r="".concat(MB.urlRootHTMLZip(),"images/keyboards/android_").concat(t,"_").concat(n,".png")
return m.default.createElement("img",{src:r,className:"keyboard-img",alt:"keyboard",draggable:!1})}}]),t}(b),W=function(e){function t(){return(0,c.default)(this,t),(0,f.default)(this,(0,p.default)(t).apply(this,arguments))}return(0,h.default)(t,e),(0,u.default)(t,[{key:"render",value:function(){return m.default.createElement("div",{className:"image"},m.default.createElement("img",{draggable:!1,src:MB.staticMap()}))}}]),t}(b),H=function(e){function t(){return(0,c.default)(this,t),(0,f.default)(this,(0,
p.default)(t).apply(this,arguments))}return(0,h.default)(t,e),(0,u.default)(t,[{key:"render",value:function(){var e=this.props.widget
return m.default.createElement("div",null,m.default.createElement("div",{className:"text_edit"},m.default.createElement("input",{type:"text",placeholder:e.text})),m.default.createElement("i",{className:"fa fa-search"}))}}]),t}(b),z=function(e){function t(){return(0,c.default)(this,t),(0,f.default)(this,(0,p.default)(t).apply(this,arguments))}return(0,h.default)(t,e),(0,u.default)(t,[{key:"render",value:function(){var e=this.props.widget,t=e.tc
...
m.default.createElement("div",{className:"time"},"12:00",m.default.createElement("span",{className:"meridian"}," AM")),m.default.createElement("div",{className:"wifi md"},"wifi"),m.default.createElement("div",{className:"battery"},m.default.createElement("div",{className:"body",style:{borderColor:t}},m.default.createElement("div",{className:"inner",style:{backgroundColor:t}})),m.default.createElement("div",{className:"head",style:{backgroundColor:t}})))}}]),t}(b),V=function(e){function t(){return(0,
...
return m.default.createElement("div",{className:"iOS-StatusBar",style:{color:e}},m.default.createElement("div",{className:"StatusBarSignal",dangerouslySetInnerHTML:{__html:v.IOS_SIGNAL}}),m.default.createElement("div",{className:"StatusBarWifi",dangerouslySetInnerHTML:{__html:v.IOS_WIFI}}),m.default.createElement("div",{className:"StatusBarTime"},"12:00"),m.default.createElement("div",{className:"StatusBarBattery",dangerouslySetInnerHTML:{__html:v.IOS_BATTERY}}))}}]),t}(b),Y=function(e){function t(){return(
...
return m.default.createElement("div",{className:"iPhoneX-StatusBar",style:{color:e}},m.default.createElement("div",{className:"StatusBarTime"},"12:00"),m.default.createElement("div",{className:"StatusBarSignal",dangerouslySetInnerHTML:{__html:v.IOS_SIGNAL}}),m.default.createElement("div",{className:"StatusBarWifi",dangerouslySetInnerHTML:{__html:v.IOS_WIFI}}),m.default.createElement("div",{className:"StatusBarBattery",dangerouslySetInnerHTML:{__html:v.IOS_BATTERY}}))}}]),t}(b),Z=function(e){function t(){
...
return m.default.createElement("label",{className:"iOS-Check"},m.default.createElement("input",{key:e.screenstate_cid+e.checked,type:"checkbox",defaultChecked:e.checked}),m.default.createElement("span",{className:"CheckState"},m.default.createElement("svg",{width:"13",height:"8",viewBox:"0 0 13 8"},m.default.createElement("path",{d:"M1 4.5L4.5 8l8-8"}))))}}]),t}(b),K=function(e){function t(){return(0,c.default)(this,t),(0,f.default)(this,(0,p.default)(t).apply(this,arguments))}return(0,h.default)(t,e),(0,
u.default)(t,[{key:"render",value:function(){var e=this.props.widget
return m.default.createElement("label",{className:"Android-Check"},m.default.createElement("input",{key:e.screenstate_cid+e.checked,type:"checkbox",defaultChecked:e.checked}),m.default.createElement("span",{className:"CheckState"},m.default.createElement("svg",{width:"14",height:"10",viewBox:"0 0 14 10"},m.default.createElement("path",{d:"M5 10L0 5.192l1.4-1.346L5 7.308 12.6 0 14 1.346"}))))}}]),t}(b),Q=function(e){function t(){return(0,c.default)(this,t),(0,f.default)(this,(0,p.default)(t).apply(this,
...
return m.default.createElement("div",{className:"wrapper"},(0,g.getIcon)(e),m.default.createElement("span",{className:"text"},e.text))}}]),t}(b),ee=function(e){function t(){return(0,c.default)(this,t),(0,f.default)(this,(0,p.default)(t).apply(this,arguments))}return(0,h.default)(t,e),(0,u.default)(t,[{key:"render",value:function(){var e=this.props.widget,t=Link.find(e.link_cids),n=t?t.gesture:"tap"
return m.default.createElement("i",{className:"icon-gesture-".concat(n)})}}]),t}(b),te=function(e){function t(){return(0,c.default)(this,t),(0,f.default)(this,(0,p.default)(t).apply(this,arguments))}return(0,h.default)(t,e),(0,u.default)(t,[{key:"render",value:function(){var e=this.props.widget
return(0,g.getIcon)(e)}}]),t}(b),ne=function(e){function t(){return(0,c.default)(this,t),(0,f.default)(this,(0,p.default)(t).apply(this,arguments))}return(0,h.default)(t,e),(0,u.default)(t,[{key:"render",value:function(){var e=this.props.widget.text.replace(/<\/?p>/g,"")
return m.default.createElement("p",{dangerouslySetInnerHTML:{__html:e}})}}]),t}(b),re=function(e){function t(){return(0,c.default)(this,t),(0,f.default)(this,(0,p.default)(t).apply(this,arguments))}return(0,h.default)(t,e),(0,u.default)(t,[{key:"render",value:function(){var e=this.props.widget,t={padding:e.paddingS()}
return m.default.createElement("div",{className:"text",style:t,dangerouslySetInnerHTML:{__html:MB.v.multiline(e.text)}})}}]),t}(b),ae=function(e){function a(){var e,s;(0,c.default)(this,a)
for(var t=arguments.length,n=new Array(t),r=0;r<t;r++)n[r]=arguments[r]
...
return m.default.createElement("div",null,m.default.createElement("div",{className:"text",dangerouslySetInnerHTML:{__html:MB.v.multiline(e.text)}}),m.default.createElement("div",{className:"sideline",style:c},m.default.createElement("div",{className:"box",style:o}),m.default.createElement("div",{className:"line",style:i},m.default.createElement("div",{className:"arrow",style:u,onMouseDown:this.handleDown}))),m.default.createElement("div",{className:"sawtooth",style:l}))}}]),a}(b),oe=function(e){function t(
...
return m.default.createElement("div",null,m.default.createElement("div",{className:"arrow1 arrow ".concat(n.tt_placement),style:i}),m.default.createElement("div",{className:"arrow2 arrow ".concat(n.tt_placement),style:c}),m.default.createElement("div",{className:"text",style:u,dangerouslySetInnerHTML:{__html:MB.v.multiline(n.text)}}))}}]),t}(b)},ubZ9:function(e,t,n){"use strict"
var r=n("284h"),a=n("TqRt")
...
e.exports=function(e){return"function"==typeof e?e:null==e?o:"object"==typeof e?i(e)?a(e[0],e[1]):r(e):c(e)}},v4Lw:function(e,t,n){"use strict"
var r=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.decompressRichText=t.compressRichText=t.getUnescapedText=t.getEscapedText=void 0
var a=r(n("MVZn")),o=r(n("J4zp")),i=n("yUqi"),c=n("Clcl"),u=[["&","&amp;"],["<","&lt;"],[">","&gt;"]],l=u.concat().reverse()
t.getEscapedText=function(e){var a=e
return u.forEach(function(e){var t=(0,o.default)(e,2),n=t[0],r=t[1]
return a=a.replace(new RegExp(n,"g"),r)}),a}
t.getUnescapedText=function(e){var a=e
return l.forEach(function(e){var t=(0,o.default)(e,2),n=t[0],r=t[1]
return a=a.replace(new RegExp(r,"g"),n)}),a}
...
t.decompressRichText=d},v8PR:function(e,t,n){},v9Wr:function(e,t,n){"use strict"
var r=n("284h"),a=n("TqRt")
Object.defineProperty(t,"__esModule",{value:!0}),t.default=void 0
...
return t.defaultView||t.parentWindow||o}var I="ontouchstart"in o,P=R(o,"PointerEvent")!==m,A=I&&/mobile|tablet|ip(ad|hone|od)|android/i.test(navigator.userAgent),j="touch",L=25,B=1,D=4,U=8,F=1,q=2,W=4,H=8,z=16,V=q|W,Y=H|z,Z=V|Y,X=["x","y"],J=["clientX","clientY"]
function G(t,e){var n=this
this.manager=t,this.callback=e,this.element=t.element,this.target=t.options.inputTarget,this.domHandler=function(e){b(t.options.enable,[t])&&n.handler(e)},this.init()}function K(e,t,n){var r=n.pointers.length,a=n.changedPointers.length,o=t&B&&r-a==0,i=t&(D|U)&&r-a==0
...
t.eventType!==B&&o.eventType!==D||(a=e.prevDelta={x:o.deltaX||0,y:o.deltaY||0},r=e.offsetDelta={x:n.x,y:n.y})
...
t.overallVelocityX=l.x,t.overallVelocityY=l.y,t.overallVelocity=v(l.x)>v(l.y)?l.x:l.y,t.scale=i?(f=i.pointers,p=r,ne(p[0],p[1],J)/ne(f[0],f[1],J)):1,t.rotation=i?(s=i.pointers,d=r,re(d[1],d[0],J)+re(s[1],s[0],J)):0,t.maxPointers=n.prevInput?t.pointers.length>n.prevInput.maxPointers?t.pointers.length:n.prevInput.maxPointers:t.pointers.length,function(e,t){var n,r,a,o,i=e.lastInterval||t,c=t.timeStamp-i.timeStamp
if(t.eventType!=U&&(L<c||i.velocity===m)){var u=t.deltaX-i.deltaX,l=t.deltaY-i.deltaY,s=ee(c,u,l)
...
return{x:l(n/t),y:l(r/t)}}function ee(e,t,n){return{x:t/e||0,y:n/e||0}}function te(e,t){return e===t?F:v(e)>=v(t)?e<0?q:W:t<0?H:z}function ne(e,t,n){n||(n=X)
...
var ae={mousedown:B,mousemove:2,mouseup:D},oe="mousedown",ie="mousemove mouseup"
function ce(){this.evEl=oe,this.evWin=ie,this.pressed=!1,G.apply(this,arguments)}h(ce,G,{handler:function(e){var t=ae[e.type]
t&B&&0===e.button&&(this.pressed=!0),2&t&&1!==e.which&&(t=D),this.pressed&&(t&D&&(this.pressed=!1),this.callback(this.manager,t,{pointers:[e],changedPointers:[e],pointerType:"mouse",srcEvent:e}))}})
var ue={pointerdown:B,pointermove:2,pointerup:D,pointercancel:U,pointerout:U},le={2:j,3:"pen",4:"mouse",5:"kinect"},se="pointerdown",de="pointermove pointerup pointercancel"
function fe(){this.evEl=se,this.evWin=de,G.apply(this,arguments),this.store=this.manager.session.pointerEvents=[]}o.MSPointerEvent&&!o.PointerEvent&&(se="MSPointerDown",de="MSPointerMove MSPointerUp MSPointerCancel"),h(fe,G,{handler:function(e){var t=this.store,n=!1,r=e.type.toLowerCase().replace("ms",""),a=ue[r],o=le[e.pointerType]||e.pointerType,i=o==j,c=k(t,e.pointerId,"pointerId")
a&B&&(0===e.button||i)?c<0&&(t.push(e),c=t.length-1):a&(D|U)&&(n=!0),c<0||(t[c]=e,this.callback(this.manager,a,{pointers:t,changedPointers:[e],pointerType:o,srcEvent:e}),n&&t.splice(c,1))}})
var pe={touchstart:B,touchmove:2,touchend:D,touchcancel:U}
...
if(t===B&&(this.started=!0),this.started){var n=function(e,t){var n=M(e.touches),r=M(e.changedTouches)
t&(D|U)&&(n=T(n.concat(r),"identifier",!0))
return[n,r]}.call(this,e,t)
t&(D|U)&&n[0].length-n[1].length==0&&(this.started=!1),this.callback(this.manager,t,{pointers:n[0],changedPointers:n[1],pointerType:j,srcEvent:e})}}})
var me={touchstart:B,touchmove:2,touchend:D,touchcancel:U},ve="touchstart touchmove touchend touchcancel"
...
if(t&(2|B)&&1===n.length)return r[n[0].identifier]=!0,[n,n]
var a,o,i=M(e.changedTouches),c=[],u=this.target
if(o=n.filter(function(e){return C(e.target,u)}),t===B)for(a=0;a<o.length;)r[o[a].identifier]=!0,a++
a=0
for(;a<i.length;)r[i[a].identifier]&&c.push(i[a]),t&(D|U)&&delete r[i[a].identifier],a++
...
setTimeout(function(){var e=r.indexOf(n);-1<e&&r.splice(e,1)},ye)}}h(be,G,{handler:function(e,t,n){var r=n.pointerType==j,a="mouse"==n.pointerType
if(!(a&&n.sourceCapabilities&&n.sourceCapabilities.firesTouchEvents)){if(r)(function(e,t){e&B?(this.primaryTouch=t.changedPointers[0].identifier,we.call(this,t)):e&(D|U)&&we.call(this,t)}).call(this,t,n)
...
return n?n.get(e):e}function Ae(){Ne.apply(this,arguments)}function je(){Ae.apply(this,arguments),this.pX=null,this.pY=null}function Le(){Ae.apply(this,arguments)}function Be(){Ne.apply(this,arguments),this._timer=null,this._input=null}function De(){Ae.apply(this,arguments)}function Ue(){Ae.apply(this,arguments)}function Fe(){Ne.apply(this,arguments),this.pTime=!1,this.pCenter=!1,this._timer=null,this._input=null,this.count=0}function qe(e,t){return(t=t||{}).recognizers=w(t.recognizers,qe.defaults.preset),
...
return r&&(n&U||!a)?16|t:r||a?n&D?8|t:2&t?4|t:2:32}}),h(je,Ae,{defaults:{event:"pan",threshold:10,pointers:1,direction:Z},getTouchAction:function(){var e=this.options.direction,t=[]
...
e.additionalEvent=this.options.event+t}this._super.emit.call(this,e)}}),h(Be,Ne,{defaults:{event:"press",pointers:1,time:251,threshold:9},getTouchAction:function(){return["auto"]},process:function(e){var t=this.options,n=e.pointers.length===t.pointers,r=e.distance<t.threshold,a=e.deltaTime>t.time
if(this._input=e,!r||!n||e.eventType&(D|U)&&!a)this.reset()
else if(e.eventType&B)this.reset(),this._timer=s(function(){this.state=8,this.tryEmit()},t.time,this)
else if(e.eventType&D)return 8
return 32},reset:function(){clearTimeout(this._timer)},emit:function(e){8===this.state&&(e&&e.eventType&D?this.manager.emit(this.options.event+"up",e):(this._input.timeStamp=g(),this.manager.emit(this.options.event,this._input)))}}),h(De,Ae,{defaults:{event:"rotate",threshold:0,pointers:2},getTouchAction:function(){return[_e]},attrTest:function(e){return this._super.attrTest.call(this,e)&&(Math.abs(e.rotation)>this.options.threshold||2&this.state)}}),h(Ue,Ae,{defaults:{event:"swipe",threshold:10,
velocity:.3,direction:V|Y,pointers:1},getTouchAction:function(){return je.prototype.getTouchAction.call(this)},attrTest:function(e){var t,n=this.options.direction
return n&(V|Y)?t=e.overallVelocity:n&V?t=e.overallVelocityX:n&Y&&(t=e.overallVelocityY),this._super.attrTest.call(this,e)&&n&e.offsetDirection&&e.distance>this.options.threshold&&e.maxPointers==this.options.pointers&&v(t)>this.options.velocity&&e.eventType&D},emit:function(e){var t=Ie(e.offsetDirection)
...
if(r&&a&&n){if(e.eventType!=D)return this.failTimeout()
...
qe.VERSION="2.0.7",qe.defaults={domEvents:!1,touchAction:"compute",enable:!0,inputTarget:null,inputClass:null,preset:[[De,{enable:!1}],[Le,{enable:!1},["rotate"]],[Ue,{direction:V}],[je,{direction:V},["swipe"]],[Fe],[Fe,{event:"doubletap",taps:2},["tap"]],[Be]],cssProps:{userSelect:"none",touchSelect:"none",touchCallout:"none",contentZooming:"none",userDrag:"none",tapHighlightColor:"rgba(0,0,0,0)"}}
...
for(var i=0;i<o.length;)o[i](t),i++}},destroy:function(){this.element&&He(this,!1),this.handlers={},this.session={},this.input.destroy(),this.element=null}},i(qe,{INPUT_START:B,INPUT_MOVE:2,INPUT_END:D,INPUT_CANCEL:U,STATE_POSSIBLE:Re,STATE_BEGAN:2,STATE_CHANGED:4,STATE_ENDED:8,STATE_RECOGNIZED:8,STATE_CANCELLED:16,STATE_FAILED:32,DIRECTION_NONE:F,DIRECTION_LEFT:q,DIRECTION_RIGHT:W,DIRECTION_UP:H,DIRECTION_DOWN:z,DIRECTION_HORIZONTAL:V,DIRECTION_VERTICAL:Y,DIRECTION_ALL:Z,Manager:We,Input:G,TouchAction:Te,
TouchInput:ge,MouseInput:ce,PointerEventInput:fe,TouchMouseInput:be,SingleTouchInput:he,Recognizer:Ne,AttrRecognizer:Ae,Tap:Fe,Pan:je,Swipe:Ue,Pinch:Le,Rotate:De,Press:Be,on:S,off:E,each:d,merge:p,extend:f,assign:i,inherit:h,bindFn:y,prefixed:R}),(void 0!==o?o:"undefined"!=typeof self?self:{}).Hammer=qe,(Ze=function(){return qe}.call(Ve,Ye,Ve,ze))===m||(ze.exports=Ze)}(window,document)},yOnP:function(e,t,n){"use strict"
var r=n("TqRt")
...
//# sourceMappingURL=lib-preview-fbe77f4926dbeef88819.js.map